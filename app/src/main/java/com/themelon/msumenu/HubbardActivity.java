...
public class HubbardActivity extends MainActivity
    ...
    String url = "https://eatatstate.com/menus/hubbard";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hubbard);
    ...
    public void selectDrawerItem(MenuItem menuItem) {
        ...
        switch(menuItem.getItemId()) {
            ...
            case R.id.nav_first_fragment:
                ...
                Intent intent = new Intent(HubbardActivity.this, MainActivity.class);
                startActivity(intent);
                break;

            case R.id.nav_second_fragment:
                fragmentClass = SecondFragment.class;
                intent = new Intent(HubbardActivity.this, ChatActivity.class);
                startActivity(intent);
                break;
    ...
    private class Title extends AsyncTask<Void, Void, Void> {
        ...
        ArrayList<String> FLBreakfastArray = new ArrayList<String>();
        ArrayList<String> FLLunchArray = new ArrayList<String>();
        ArrayList<String> FLDinnerArray = new ArrayList<String>();
        ArrayList<String> FLLateNightArray = new ArrayList<String>();
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            mProgressDialog = new ProgressDialog(HubbardActivity.this);
            mProgressDialog.setTitle("Hubbard Menu");
            mProgressDialog.setMessage("Loading Hubbard Menu");
        ...
        protected Void doInBackground(Void...params){
            try {
                ...
                backgrounddoin(document, "Origins", Breakfast, Lunch,Dinner,LateNight,FLBreakfastArray,FLLunchArray,FLDinnerArray,FLLateNightArray);
                backgrounddoin(document, "Levels", Breakfast, Lunch,Dinner,LateNight,PIBreakfastArray,PILunchArray,PIDinnerArray,PILateNightArray);
        ...
        protected void onPostExecute(Void result) {
            ...
            TextView FLBreakfast = (TextView)findViewById(R.id.FLBreakfasttxt);
            settingText(FLBreakfastArray,FLBreakfast);


            TextView FLLunch = (TextView)findViewById(R.id.FLLunchTxt);
            settingText(FLLunchArray,FLLunch);


            TextView FLDinner = (TextView) findViewById(R.id.FLDinnerTxt);
            settingText(FLDinnerArray,FLDinner);

            TextView FLLateNight = (TextView) findViewById(R.id.FLLateNightTxt);
            settingText(FLLateNightArray,FLLateNight);
            equalTextview(FLBreakfast,FLLunch,FLDinner,FLLateNight);
