...
public class RiverwalkActivity extends MainActivity
    ...
    String url = "https://eatatstate.com/menus/riverwalk";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_riverwalk);
    ...
    public void selectDrawerItem(MenuItem menuItem) {
        ...
        switch(menuItem.getItemId()) {
            ...
            case R.id.nav_first_fragment:
                ...
                Intent intent = new Intent(RiverwalkActivity.this, MainActivity.class);
                startActivity(intent);
                break;

            case R.id.nav_second_fragment:
                fragmentClass = SecondFragment.class;
                intent = new Intent(RiverwalkActivity.this, ChatActivity.class);
                startActivity(intent);
                break;
    ...
    private class Title extends AsyncTask<Void, Void, Void> {
        ...
        ArrayList<String> GRBreakfastArray = new ArrayList<String>();
        ArrayList<String> GRLunchArray = new ArrayList<String>();
        ArrayList<String> GRDinnerArray = new ArrayList<String>();
        ArrayList<String> GRLateNightArray = new ArrayList<String>();



        ArrayList<String> PIBreakfastArray = new ArrayList<String>();
        ArrayList<String> PILunchArray = new ArrayList<String>();
        ArrayList<String> PIDinnerArray = new ArrayList<String>();
        ArrayList<String> PILateNightArray = new ArrayList<String>();
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            mProgressDialog = new ProgressDialog(RiverwalkActivity.this);
            mProgressDialog.setTitle("Riverwalk Market Menu");
            mProgressDialog.setMessage("Loading Riverwalk Market Menu");
        ...
        protected Void doInBackground(Void...params){
            try {
                ...
                backgrounddoin(document, "Grill", Breakfast, Lunch,Dinner,LateNight,GRBreakfastArray,GRLunchArray,GRDinnerArray,GRLateNightArray);
                backgrounddoin(document, "Pizza", Breakfast, Lunch,Dinner,LateNight,PIBreakfastArray,PILunchArray,PIDinnerArray,PILateNightArray);
        ...
        protected void onPostExecute(Void result) {
            ...
            TextView GRBreakfast = (TextView)findViewById(R.id.GRBreakfasttxt);
            settingText(GRBreakfastArray,GRBreakfast);


            TextView GRLunch = (TextView)findViewById(R.id.GRLunchTxt);
            settingText(GRLunchArray,GRLunch);


            TextView GRDinner = (TextView) findViewById(R.id.GRDinnerTxt);
            settingText(GRDinnerArray,GRDinner);

            TextView GRLateNight = (TextView) findViewById(R.id.FLLateNightTxt);
            settingText(GRLateNightArray,GRLateNight);
            equalTextview(GRBreakfast,GRLunch,GRDinner,GRLateNight);



            TextView PIBreakfast = (TextView)findViewById(R.id.PIBreakfasttxt);
           // settingText(PIBreakfastArray,PIBreakfast);

            TextView PILunch = (TextView)findViewById(R.id.PILunchTxt);
         //   settingText(PILunchArray,PILunch);

            TextView PIDinner = (TextView) findViewById(R.id.PIDinnerTxt);
       //     settingText(PIDinnerArray,PIDinner);

            TextView PILateNight = (TextView) findViewById(R.id.PILateNightTxt);
            settingText(PILateNightArray,PILateNight);
     //       equalTextview(PIBreakfast,PILunch,PIDinner,PILateNight);
